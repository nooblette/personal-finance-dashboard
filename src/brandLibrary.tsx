...
const brands: Brand[] = [
  ...
  { id: "shinhan-card", name: "신한카드", kind: "card", initials: "신한", bg: "bg-blue-700", fg: "text-white", hasOriginal: true, hasFill: true, logoAlias: "shinhan" },
  ...
  { id: "kb-card", name: "KB국민카드", kind: "card", initials: "KB", bg: "bg-yellow-400", fg: "text-zinc-900", hasOriginal: true, hasFill: true, logoAlias: "kb" },
  { id: "lotte-card", name: "롯데카드", kind: "card", initials: "롯데", bg: "bg-red-700", fg: "text-white", hasOriginal: true, hasFill: true },
  { id: "hana-card", name: "하나카드", kind: "card", initials: "하나", bg: "bg-teal-700", fg: "text-white", hasOriginal: true, hasFill: true, logoAlias: "hana" },
  { id: "woori-card", name: "우리카드", kind: "card", initials: "우리", bg: "bg-sky-700", fg: "text-white", hasOriginal: true, hasFill: true, logoAlias: "woori" },
  { id: "bc-card", name: "BC카드", kind: "card", initials: "BC", bg: "bg-rose-600", fg: "text-white", hasOriginal: true, hasFill: true },
  { id: "nh-card", name: "NH농협카드", kind: "card", initials: "NH", bg: "bg-green-600", fg: "text-white", hasOriginal: true, hasFill: true, logoAlias: "nh" },
  { id: "ibk-card", name: "IBK기업은행카드", kind: "card", initials: "IBK", bg: "bg-blue-600", fg: "text-white", hasOriginal: true, hasFill: true, logoAlias: "ibk" },
  { id: "suhyup-card", name: "Sh수협카드", kind: "card", initials: "Sh", bg: "bg-sky-500", fg: "text-white", hasOriginal: true, hasFill: true, logoAlias: "suhyup" },
