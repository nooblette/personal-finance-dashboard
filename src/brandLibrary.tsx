...
const brands: Brand[] = [
  ...
  { id: "mirae-asset", name: "미래에셋증권", kind: "sec", initials: "미래", bg: "bg-orange-500", fg: "text-white" },
  { id: "kis", name: "한국투자증권", kind: "sec", initials: "한투", bg: "bg-red-600", fg: "text-white" },
  { id: "samsung-sec", name: "삼성증권", kind: "sec", initials: "삼성", bg: "bg-blue-800", fg: "text-white" },
  { id: "nh-sec", name: "NH투자증권", kind: "sec", initials: "NH", bg: "bg-green-600", fg: "text-white" },
  { id: "kb-sec", name: "KB증권", kind: "sec", initials: "KB", bg: "bg-yellow-400", fg: "text-zinc-900" },
  ...
  { id: "db-sec", name: "DB금융투자", kind: "sec", initials: "DB", bg: "bg-emerald-800", fg: "text-white" },
  ...
  { id: "sk-sec", name: "SK증권", kind: "sec", initials: "SK", bg: "bg-orange-600", fg: "text-white" },
  { id: "hanwha-sec", name: "한화투자증권", kind: "sec", initials: "한화", bg: "bg-amber-700", fg: "text-white" },
